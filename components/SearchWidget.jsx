...
export default function SearchWidget() {
  ...
  // Instant, zero-latency preview from the bundled defaults — this can go
  // stale the moment an admin edits meter rates in /admin/meter-rates, so
  // it's only ever shown before the real quote below arrives, never sent
