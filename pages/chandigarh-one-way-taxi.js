...
].filter((x) => x !== "/chandigarh-one-way-taxi").slice(0, 4);

export default function RoutePage() {
  return (
    <div className="bg-road min-h-screen">
      <Head>
        <title>Chandigarh One Way Taxi | Sahota Travel</title>
        <meta name="description" content="One-way taxi booking is useful when you need a private cab to a destination without booking the same vehicle for the return journey. Book online with Sahota Travel and choose a suitable cab for your journey." />
        <link rel="canonical" href="https://sahotatravel.netlify.app/chandigarh-one-way-taxi" />
        <meta property="og:title" content="Chandigarh One Way Taxi | Sahota Travel" />
        <meta property="og:description" content="One-way taxi booking is useful when you need a private cab to a destination without booking the same vehicle for the return journey." />
        <meta property="og:url" content="https://sahotatravel.netlify.app/chandigarh-one-way-taxi" />
        <meta property="og:type" content="website" />
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context":"https://schema.org", "@type":"Service", "name":"Chandigarh One Way Taxi",
      ...
      <main className="max-w-4xl mx-auto px-5 py-16">
        ...
        <h1 className="font-display text-paper text-4xl md:text-5xl leading-tight">Chandigarh One Way Taxi</h1>
        <p className="font-body text-steel text-lg mt-5 leading-relaxed">One-way taxi booking is useful when you need a private cab to a destination without booking the same vehicle for the return journey.</p>
