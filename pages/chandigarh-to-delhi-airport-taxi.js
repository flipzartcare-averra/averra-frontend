...
].filter((x) => x !== "/chandigarh-to-delhi-airport-taxi").slice(0, 4);

export default function RoutePage() {
  return (
    <div className="bg-road min-h-screen">
      <Head>
        <title>Chandigarh to Delhi Airport Taxi | Sahota Travel</title>
        <meta name="description" content="Book a private airport transfer from Chandigarh to Delhi Airport and plan your pickup around your flight schedule. Book online with Sahota Travel and choose a suitable cab for your journey." />
        <link rel="canonical" href="https://sahotatravel.netlify.app/chandigarh-to-delhi-airport-taxi" />
        <meta property="og:title" content="Chandigarh to Delhi Airport Taxi | Sahota Travel" />
        <meta property="og:description" content="Book a private airport transfer from Chandigarh to Delhi Airport and plan your pickup around your flight schedule." />
        <meta property="og:url" content="https://sahotatravel.netlify.app/chandigarh-to-delhi-airport-taxi" />
        <meta property="og:type" content="website" />
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context":"https://schema.org", "@type":"Service", "name":"Chandigarh to Delhi Airport Taxi",
          "provider":{"@type":"Organization","name":"Sahota Travel","url":"https://sahotatravel.netlify.app/"},
          "serviceType":"Taxi Service", "areaServed":["Chandigarh","Delhi Airport"]
        }) }} />
      </Head>
      <Header />
      <main className="max-w-4xl mx-auto px-5 py-16">
        <p className="font-mono text-taxi text-xs uppercase tracking-[0.25em] mb-4">Taxi booking · Sahota Travel</p>
        <h1 className="font-display text-paper text-4xl md:text-5xl leading-tight">Chandigarh to Delhi Airport Taxi</h1>
        <p className="font-body text-steel text-lg mt-5 leading-relaxed">Book a private airport transfer from Chandigarh to Delhi Airport and plan your pickup around your flight schedule.</p>
        <div className="grid sm:grid-cols-3 gap-4 mt-10">
          <div className="border border-roadline rounded-md p-5"><p className="font-mono text-xs text-steel uppercase">Typical distance</p><p className="text-paper text-xl mt-2">260 km</p></div>
          <div className="border border-roadline rounded-md p-5"><p className="font-mono text-xs text-steel uppercase">Typical journey</p><p className="text-paper text-xl mt-2">about 5–6h</p></div>
          <div className="border border-roadline rounded-md p-5"><p className="font-mono text-xs text-steel uppercase">Route</p><p className="text-paper text-sm mt-2">Chandigarh → Ambala → Panipat → Delhi</p></div>
        </div>
        <section className="mt-12">
          <h2 className="font-display text-paper text-2xl mb-4">Chandigarh to Delhi Airport cab booking</h2>
