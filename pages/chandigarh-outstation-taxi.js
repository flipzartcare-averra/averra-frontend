...
].filter((x) => x !== "/chandigarh-outstation-taxi").slice(0, 4);

export default function RoutePage() {
  return (
    <div className="bg-road min-h-screen">
      <Head>
        <title>Chandigarh Outstation Taxi | Sahota Travel</title>
        <meta name="description" content="Book an outstation cab from Chandigarh for one-way or return journeys across Punjab, Haryana, Himachal Pradesh, Uttarakhand, Delhi and nearby destinations. Book online with Sahota Travel and choose a suitable cab for your journey." />
        <link rel="canonical" href="https://sahotatravel.netlify.app/chandigarh-outstation-taxi" />
        <meta property="og:title" content="Chandigarh Outstation Taxi | Sahota Travel" />
        <meta property="og:description" content="Book an outstation cab from Chandigarh for one-way or return journeys across Punjab, Haryana, Himachal Pradesh, Uttarakhand, Delhi and nearby destinations." />
        <meta property="og:url" content="https://sahotatravel.netlify.app/chandigarh-outstation-taxi" />
        <meta property="og:type" content="website" />
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context":"https://schema.org", "@type":"Service", "name":"Chandigarh Outstation Taxi",
      ...
      <main className="max-w-4xl mx-auto px-5 py-16">
        ...
        <h1 className="font-display text-paper text-4xl md:text-5xl leading-tight">Chandigarh Outstation Taxi</h1>
        <p className="font-body text-steel text-lg mt-5 leading-relaxed">Book an outstation cab from Chandigarh for one-way or return journeys across Punjab, Haryana, Himachal Pradesh, Uttarakhand, Delhi and nearby destinations.</p>
