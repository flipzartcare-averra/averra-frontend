...
].filter((x) => x !== "/chandigarh-to-kasauli-taxi").slice(0, 4);

export default function RoutePage() {
  return (
    <div className="bg-road min-h-screen">
      <Head>
        <title>Chandigarh to Kasauli Taxi | Sahota Travel</title>
        <meta name="description" content="Kasauli is a popular short hill escape from Chandigarh. A private taxi gives you door-to-door travel and room for luggage. Book online with Sahota Travel and choose a suitable cab for your journey." />
        <link rel="canonical" href="https://sahotatravel.netlify.app/chandigarh-to-kasauli-taxi" />
        <meta property="og:title" content="Chandigarh to Kasauli Taxi | Sahota Travel" />
        <meta property="og:description" content="Kasauli is a popular short hill escape from Chandigarh. A private taxi gives you door-to-door travel and room for luggage." />
        <meta property="og:url" content="https://sahotatravel.netlify.app/chandigarh-to-kasauli-taxi" />
        <meta property="og:type" content="website" />
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context":"https://schema.org", "@type":"Service", "name":"Chandigarh to Kasauli Taxi",
          "provider":{"@type":"Organization","name":"Sahota Travel","url":"https://sahotatravel.netlify.app/"},
          "serviceType":"Taxi Service", "areaServed":["Chandigarh","Kasauli"]
        }) }} />
      </Head>
      <Header />
      <main className="max-w-4xl mx-auto px-5 py-16">
        <p className="font-mono text-taxi text-xs uppercase tracking-[0.25em] mb-4">Taxi booking · Sahota Travel</p>
        <h1 className="font-display text-paper text-4xl md:text-5xl leading-tight">Chandigarh to Kasauli Taxi</h1>
        <p className="font-body text-steel text-lg mt-5 leading-relaxed">Kasauli is a popular short hill escape from Chandigarh. A private taxi gives you door-to-door travel and room for luggage.</p>
        <div className="grid sm:grid-cols-3 gap-4 mt-10">
          <div className="border border-roadline rounded-md p-5"><p className="font-mono text-xs text-steel uppercase">Typical distance</p><p className="text-paper text-xl mt-2">60 km</p></div>
          <div className="border border-roadline rounded-md p-5"><p className="font-mono text-xs text-steel uppercase">Typical journey</p><p className="text-paper text-xl mt-2">about 2–2.5h</p></div>
          <div className="border border-roadline rounded-md p-5"><p className="font-mono text-xs text-steel uppercase">Route</p><p className="text-paper text-sm mt-2">Chandigarh → Kalka → Parwanoo → Kasauli</p></div>
        </div>
        <section className="mt-12">
          <h2 className="font-display text-paper text-2xl mb-4">Chandigarh to Kasauli cab booking</h2>
        ...
        <section className="mt-10">
          ...
          <ol className="list-decimal pl-6 font-body text-steel leading-relaxed space-y-2">
            <li>Open the Sahota Travel booking form.</li><li>Enter Chandigarh as pickup and Kasauli as destination where applicable.</li><li>Select your date, journey details and cab type.</li><li>Review the estimated fare and submit your contact information.</li><li>Wait for booking confirmation from the Sahota Travel team.</li>
          </ol>
        </section>
        <section className="mt-10">
