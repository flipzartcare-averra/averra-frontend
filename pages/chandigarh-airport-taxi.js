...
].filter((x) => x !== "/chandigarh-airport-taxi").slice(0, 4);

export default function RoutePage() {
  return (
    <div className="bg-road min-h-screen">
      <Head>
        <title>Chandigarh Airport Taxi | Sahota Travel</title>
        <meta name="description" content="Arrange a pre-booked pickup or drop from Chandigarh Airport for local and outstation journeys. Book online with Sahota Travel and choose a suitable cab for your journey." />
        <link rel="canonical" href="https://sahotatravel.netlify.app/chandigarh-airport-taxi" />
        <meta property="og:title" content="Chandigarh Airport Taxi | Sahota Travel" />
        <meta property="og:description" content="Arrange a pre-booked pickup or drop from Chandigarh Airport for local and outstation journeys." />
        <meta property="og:url" content="https://sahotatravel.netlify.app/chandigarh-airport-taxi" />
        <meta property="og:type" content="website" />
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context":"https://schema.org", "@type":"Service", "name":"Chandigarh Airport Taxi",
          "provider":{"@type":"Organization","name":"Sahota Travel","url":"https://sahotatravel.netlify.app/"},
          "serviceType":"Taxi Service", "areaServed":["Chandigarh","Chandigarh Airport"]
        }) }} />
      </Head>
      <Header />
      <main className="max-w-4xl mx-auto px-5 py-16">
        <p className="font-mono text-taxi text-xs uppercase tracking-[0.25em] mb-4">Taxi booking · Sahota Travel</p>
        <h1 className="font-display text-paper text-4xl md:text-5xl leading-tight">Chandigarh Airport Taxi</h1>
        <p className="font-body text-steel text-lg mt-5 leading-relaxed">Arrange a pre-booked pickup or drop from Chandigarh Airport for local and outstation journeys.</p>
        <div className="grid sm:grid-cols-3 gap-4 mt-10">
          ...
          <div className="border border-roadline rounded-md p-5"><p className="font-mono text-xs text-steel uppercase">Route</p><p className="text-paper text-sm mt-2">Chandigarh → Mohali airport area</p></div>
        </div>
        <section className="mt-12">
          <h2 className="font-display text-paper text-2xl mb-4">Chandigarh to Chandigarh Airport cab booking</h2>
