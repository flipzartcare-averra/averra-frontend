...
].filter((x) => x !== "/chandigarh-to-khajjiar-taxi").slice(0, 4);

export default function RoutePage() {
  return (
    <div className="bg-road min-h-screen">
      <Head>
        <title>Chandigarh to Khajjiar Taxi | Sahota Travel</title>
        <meta name="description" content="A private cab makes the long journey to Khajjiar easier for families carrying luggage and travelling on a fixed schedule. Book online with Sahota Travel and choose a suitable cab for your journey." />
        <link rel="canonical" href="https://sahotatravel.netlify.app/chandigarh-to-khajjiar-taxi" />
        <meta property="og:title" content="Chandigarh to Khajjiar Taxi | Sahota Travel" />
        <meta property="og:description" content="A private cab makes the long journey to Khajjiar easier for families carrying luggage and travelling on a fixed schedule." />
        <meta property="og:url" content="https://sahotatravel.netlify.app/chandigarh-to-khajjiar-taxi" />
        <meta property="og:type" content="website" />
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context":"https://schema.org", "@type":"Service", "name":"Chandigarh to Khajjiar Taxi",
          "provider":{"@type":"Organization","name":"Sahota Travel","url":"https://sahotatravel.netlify.app/"},
          "serviceType":"Taxi Service", "areaServed":["Chandigarh","Khajjiar"]
        }) }} />
      </Head>
      <Header />
      <main className="max-w-4xl mx-auto px-5 py-16">
        <p className="font-mono text-taxi text-xs uppercase tracking-[0.25em] mb-4">Taxi booking · Sahota Travel</p>
        <h1 className="font-display text-paper text-4xl md:text-5xl leading-tight">Chandigarh to Khajjiar Taxi</h1>
        <p className="font-body text-steel text-lg mt-5 leading-relaxed">A private cab makes the long journey to Khajjiar easier for families carrying luggage and travelling on a fixed schedule.</p>
        <div className="grid sm:grid-cols-3 gap-4 mt-10">
          <div className="border border-roadline rounded-md p-5"><p className="font-mono text-xs text-steel uppercase">Typical distance</p><p className="text-paper text-xl mt-2">350 km</p></div>
          <div className="border border-roadline rounded-md p-5"><p className="font-mono text-xs text-steel uppercase">Typical journey</p><p className="text-paper text-xl mt-2">about 9–11h</p></div>
          <div className="border border-roadline rounded-md p-5"><p className="font-mono text-xs text-steel uppercase">Route</p><p className="text-paper text-sm mt-2">Chandigarh → Pathankot → Dalhousie → Khajjiar</p></div>
        </div>
        <section className="mt-12">
          <h2 className="font-display text-paper text-2xl mb-4">Chandigarh to Khajjiar cab booking</h2>
        ...
        <section className="mt-10">
          ...
          <ol className="list-decimal pl-6 font-body text-steel leading-relaxed space-y-2">
            <li>Open the Sahota Travel booking form.</li><li>Enter Chandigarh as pickup and Khajjiar as destination where applicable.</li><li>Select your date, journey details and cab type.</li><li>Review the estimated fare and submit your contact information.</li><li>Wait for booking confirmation from the Sahota Travel team.</li>
          </ol>
        </section>
        <section className="mt-10">
